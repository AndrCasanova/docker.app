document.addEventListener('DOMContentLoaded', () => {
    if (typeof pipelineData === 'undefined') return;
    ...
    const arrowOffsetY = 15, dataPacketRadius = 8;
    const animationSpeed = 1, dataBoxHeight = 50, dataBoxPadding = 10, lineHeight = 14;
